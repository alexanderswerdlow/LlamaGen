...
--image-size 256 \
--global-batch-size $((18 * nproc_per_node * nnodes)) \
--gradient-accumulation-steps 2 \
--lr 4.5e-4 \
--ckpt-every 1000 \
--data-path '/grogu/user/mprabhud/data/diffusion/ffhq,/grogu/user/mprabhud/data/diffusion/celeba_hq,/compute/grogu-1-40/aswerdlo/data/vggface2/data/train' \
--cloud-save-path '/grogu/user/mprabhud/aswerdlo/llamagen/outputs' \
--vq-ckpt '/grogu/user/mprabhud/aswerdlo/llamagen/outputs/2024-07-03-01-10-53/022-VQ-16/checkpoints/0042000.pt' \
--disc-start 0 \
--no-local-save